...
student_no=int(input("Enter the no. of students whose data you want to input :10 "))
print()
print('-'*50)
for i in range(student_no):
    name=input("Enter Student's NamePRIYA : ")
    batch=input("Which batch they are in (e.g. 2022-26) : ")
    stream=input("Which Stream are you in (e.g. CSE) : ")
    roll=input("What is your Class Roll Number57 : ")
